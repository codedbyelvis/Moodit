    ...
    return (
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-9 profileColor">
            ...
            <div className='graphbtn'>
              ...
              <button className='graphbtn bouncy' onClick={() => this.workpls()}>See Graph!</button>
            </div>
            {/* <a href="something" className="graphbtn bouncy">Button 1</a> */}
            {/* <h3>this is the time: {this.props.time}</h3> */}
            {/* <h3>{this.props.watsonNum}</h3>
            <div className='profileTone'>
              <h3>Tones: {this.props.watsonToneName}</h3>
            </div> */}
          </div>
        </div>
