...
class Profile extends Component {
 ...
 renderChart(){
   if (this.props.watsonNum && this.props.watsonToneName && this.props.user && document.getElementById("barChart")) {
     console.log("the bar chart is trying to render")
   ...
   return (
     <div>
        ...
        { this.props.watsonNum && this.props.watsonToneName && this.props.user ? 
